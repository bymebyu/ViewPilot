...
export default function LoginScreen({ onLoginStart }: { onLoginStart: () => void }) {
  const { t } = useTranslation();
  return (
    <div className="flex flex-col items-center justify-center h-full bg-[#09090b] text-gray-100 p-8 gap-6">
      <div className="text-center">
        <div className="flex justify-center mb-4"><CopilotIcon size={56} /></div>
        <h1 className="text-xl font-bold mb-2">ViewPilot</h1>
